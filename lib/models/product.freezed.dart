...
class _$_Product implements _Product {
  ...
  @override
  String toString() {
    return 'Product(id: $id, picture: $picture, badges: $badges, price: $price, oldPrice: $oldPrice, name: $name, article: $article, rating: $rating, reviewsCount: $reviewsCount, cityFias: $cityFias, brand: $brand)';
  }
